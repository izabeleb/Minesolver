class Cell:
    ...
    def __eq__(self, other):
        ...
        and self.is_mine == other.is_mine\
        and self.is_flag == other.is_flag\
        and self.mine_count == other.mine_count\
        and self.visited == other.visited\
        and self.clicked == other.clicked
        
    def __hash__ (self):
        return hash((self.row, self.col, self.is_mine, self.is_flag, self.mine_count, self.visited, self.clicked))
